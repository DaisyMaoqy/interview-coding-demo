<script lang="ts">
	...
	const overview = $derived(employeeOverview(requests));
...
<div class="cards">
	<StatCard label="我的申请总数" value={String(overview.total)} />
	<StatCard label="审批中" value={String(overview.pending)} />
	<StatCard label="已通过" value={String(overview.approved)} />
</div>

<div class="grid">
	<Panel title="我的申请状态分布">
